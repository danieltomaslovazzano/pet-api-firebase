...
import { User } from "firebase/auth" // Importar User directamente de firebase/auth
...
export function Sidebar({ collapsed, onToggleCollapse, user }: SidebarProps) {
  ...
  return (
    <div
      className={`fixed top-0 left-0 h-full bg-slate-900 text-white transition-all duration-300 z-10 ${
        collapsed ? "w-16" : "w-64"
      }`}
    >
      {/* Header */}
        ...
        <ul className="space-y-2">
          ...
          <li>
            ...
            >
              ...
              {!collapsed && <span className="ml-3">Mascotas</span>}
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              ...
              {!collapsed && <span className="ml-3">Organizaciones</span>}
            </Link>
          </li>
          <li>
            <Link
