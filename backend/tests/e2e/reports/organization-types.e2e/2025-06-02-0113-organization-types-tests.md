...
|-----------|--------|----------|-------------|
| ✅ Should get all available organization types | PASSED | 0.68s | Should get all available organization types |
...
| ✅ Should get shelter type information | PASSED | 0.45s | Should get shelter type information |
| ✅ Should fail for invalid organization type | PASSED | 0.44s | Should fail for invalid organization type |
| ✅ Should fail without authentication | PASSED | 0.02s | Should fail without authentication |
| ✅ Should create shelter organization successfully | PASSED | 1.50s | Should create shelter organization successfully |
| ❌ Should create organization with default type when not specified | FAILED | 0.53s | Should create organization with default type when not specified |
| ❌ Should fail with invalid organization type | FAILED | 0.51s | Should fail with invalid organization type |
| ✅ Should validate required fields for shelter type | PASSED | 0.43s | Should validate required fields for shelter type |
| ✅ Should update organization type successfully | PASSED | 0.99s | Should update organization type successfully |
| ❌ Should fail when updating to invalid type | FAILED | 0.43s | Should fail when updating to invalid type |
| ✅ Should filter organizations by shelter type | PASSED | 0.86s | Should filter organizations by shelter type |
| ❌ Should fail with invalid type filter | FAILED | 0.44s | Should fail with invalid type filter |
| ✅ Should return all organizations when no type filter is applied | PASSED | 0.70s | Should return all organizations when no type filter is applied |
| ❌ Should handle empty string type | FAILED | 0.45s | Should handle empty string type |
| ✅ Should handle null type | PASSED | 0.42s | Should handle null type |
| ❌ Should handle case sensitivity | FAILED | 0.43s | Should handle case sensitivity |
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/organizations/types (671.2ms)</summary>

**📤 Request:**
```json
{
  "headers": {
    "Authorization": "Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6IjZlODk1YzQ3YTA0YzVmNmRlMzExMmFmZjE2ODFhMzUwNzdkMWNjZDQiLCJ0eXAiOiJKV1QifQ..gyvONSUQYOuSxnnJiUQ706wnDHJISfJ-jh0vMd_-EXI-wL-_0SgGGOMxv321oFdSpKiENkVKbUwqI9-ymAieEboqDKeKMoR-T_K5GgYtdqMpTUaAOSFapIGmqSuBLNGOTIS6n4Y3p7vpl7liZn4VmS_ccOIjRYcYfjrsZdKnMZEHaTJ6tnvIekiHz_45ZyGHNKLEsjSA2YrUnzE3HeCDhm97fL5Bw04CvsZIQybOKXcdLUcH9c-KCmL_sITwmVO8nGpPMHJg2fPM18km3kd0jmwHIn-h_NJWzrkR08N-jS2wVJ-bGg26ARY8I9v8nAmfgkJmwGc4u4518sdrBU790g"
  }
}
```
...
```json
{
  ...
  "headers": {
    ...
    "date": "Sun, 01 Jun 2025 23:13:13 GMT",
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/organizations/types (537.0ms)</summary>

**📤 Request:**
```json
{
  "headers": {
    "Authorization": "Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6IjZlODk1YzQ3YTA0YzVmNmRlMzExMmFmZjE2ODFhMzUwNzdkMWNjZDQiLCJ0eXAiOiJKV1QifQ..YHgRcAyqIVG3k4LueG9L6HB-JHRoKbbseOtWMr9jIHlc1axw13Hz2dhzQHuOIW_4hDlzLShp1HHyLYvi9lvPpP1NnfP6ioLMfBsMEzbKdzTOY3XyLPtUcfWAvzUmAfAtsryGkfiSYvM6uTf6sasRHVGHsvzmgeSyN5CiiUqwXco7J6YGeaKz4PND-87u14m6cRJTSNtDhgSZnelUtUhL52uWV28jJO2xP3AtcAO6ixr7sZM4jXtlfiEUTI62ZtZEbU-4sdYte057l3sKXTkh_RuTjjsEIaQY8HuuWO1rxAXjSewF4rpG-GoWctVaP_Mrq4CyLChFHhpSy9MxOglHlA"
  }
}
```
...
```json
{
  ...
  "headers": {
    ...
    "content-length": "592",
    "etag": "W/\"250-19WZZCXgK2iYWlmHr5C1Etpr4oQ\"",
    "date": "Sun, 01 Jun 2025 23:13:14 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/organizations/types (94.7ms)</summary>
...
<details><summary>📡 Request #2: GET http://localhost:3000/api/organizations/types/shelter (15.4ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-length": "34",
    "etag": "W/\"22-a5AGBJ3wo9XYPif6SAp92FOHtH4\"",
    "date": "Sun, 01 Jun 2025 23:13:15 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/organizations/types/shelter (452.2ms)</summary>
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/organizations/types/invalid_type (438.5ms)</summary>
...
<details><summary>📡 Request #1: POST http://localhost:3000/api/organizations (1496.2ms)</summary>
...
```json
{
  ...
  "data": {
    "name": "Test Shelter 1748819595296",
    "type": "shelter",
    "description": "Test shelter for E2E testing",
    "address": "123 Shelter Street",
    "phone": "+1234567890",
    "email": "test-shelter-1748819595296@example.com"
  }
}
```
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "396",
    "etag": "W/\"18c-6NXYB0PjsrR239AksiqEOIHWkvM\"",
    "date": "Sun, 01 Jun 2025 23:13:16 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    "id": "d60cffc3-7816-4ca5-81b3-9dc8d446a4c6",
    "name": "Test Shelter 1748819595296",
    "type": "shelter",
    "description": "Test shelter for E2E testing",
    "logo": null,
    ...
    "createdAt": "2025-06-01T23:13:15.759Z",
    "updatedAt": "2025-06-01T23:13:15.759Z"
  }
}
```

**⏱️ Duration:** 1496.2 ms  
...
<details><summary>📡 Request #1: POST http://localhost:3000/api/organizations (527.8ms)</summary>
...
```json
{
  ...
  "data": {
    "name": "Default Type Org 1748819596796",
    "description": "Organization without explicit type",
    "email": "default-type-1748819596796@example.com"
  }
}
```
...
```json
{
  ...
  "headers": {
    ...
    "date": "Sun, 01 Jun 2025 23:13:17 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
Expected substring: [32m"Invalid organization type"[39m
Received string:    [31m"Validation failed"[39m  

#### 🌐 HTTP Requests & Responses

<details><summary>📡 Request #1: POST http://localhost:3000/api/organizations (505.3ms)</summary>
...
<details><summary>📡 Request #1: POST http://localhost:3000/api/organizations (434.0ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "date": "Sun, 01 Jun 2025 23:13:18 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #2: POST http://localhost:3000/api/organizations (849.5ms)</summary>
...
```json
{
  ...
  "data": {
    "name": "Update Type Test Org 1748819598276",
    "type": "shelter",
    "description": "Organization for type update tests",
    "address": "456 Update Street",
    "phone": "+9876543210",
    "email": "update-type-test-1748819598276@example.com"
  }
}
```
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "413",
    "etag": "W/\"19d-MURKA8DSAmv3Jzg6ihPJEYMkNaI\"",
    "date": "Sun, 01 Jun 2025 23:13:19 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    "id": "bdba4baa-a1af-4b75-a647-118b3311eff2",
    "name": "Update Type Test Org 1748819598276",
    "type": "shelter",
    "description": "Organization for type update tests",
    "logo": null,
    ...
    "status": "active",
    "createdBy": "tYFy4ecd0TY2fErw9jsp6e1XHvw1",
    "createdAt": "2025-06-01T23:13:19.057Z",
    "updatedAt": "2025-06-01T23:13:19.057Z"
  }
}
```
...
<details><summary>📡 Request #1: PUT http://localhost:3000/api/organizations/bdba4baa-a1af-4b75-a647-118b3311eff2 (993.9ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "410",
    "etag": "W/\"19a-kG8bRoeWVEXp9g/9C6ENvFBEPDk\"",
    "date": "Sun, 01 Jun 2025 23:13:20 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    ...
    "createdBy": "tYFy4ecd0TY2fErw9jsp6e1XHvw1",
    "createdAt": "2025-06-01T23:13:19.057Z",
    "updatedAt": "2025-06-01T23:13:19.995Z"
  }
}
```
...
<details><summary>📡 Request #1: PUT http://localhost:3000/api/organizations/bdba4baa-a1af-4b75-a647-118b3311eff2 (429.1ms)</summary>
...
<details><summary>📡 Request #2: POST http://localhost:3000/api/organizations (505.6ms)</summary>
...
```json
{
  ...
  "data": {
    "name": "Filter Test Shelter 1 1748819600556",
    "type": "shelter",
    "description": "Test shelter 1 for filtering",
    "address": "100 Filter Street",
    "phone": "+1234567890",
    "email": "filter-shelter-0-1748819600556@example.com"
  }
}
```
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "408",
    "etag": "W/\"198-0pNDN06IanT5yPpZ30kWLKcR14w\"",
    "date": "Sun, 01 Jun 2025 23:13:21 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    "id": "6bb3ff06-82f4-4f96-b390-328efb5a4455",
    "name": "Filter Test Shelter 1 1748819600556",
    "type": "shelter",
    "description": "Test shelter 1 for filtering",
    "logo": null,
    ...
    "status": "active",
    "createdBy": "tYFy4ecd0TY2fErw9jsp6e1XHvw1",
    "createdAt": "2025-06-01T23:13:21.001Z",
    "updatedAt": "2025-06-01T23:13:21.001Z"
  }
}
```
...
<details><summary>📡 Request #3: POST http://localhost:3000/api/organizations (530.6ms)</summary>
...
```json
{
  ...
  "data": {
    "name": "Filter Test Shelter 2 1748819601061",
    "type": "shelter",
    "description": "Test shelter 2 for filtering",
    "address": "101 Filter Street",
    "phone": "+1234567891",
    "email": "filter-shelter-1-1748819601061@example.com"
  }
}
```
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "408",
    "etag": "W/\"198-tO6Av9kWt5P8mRuFCDjgC/BJcH0\"",
    "date": "Sun, 01 Jun 2025 23:13:21 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    "id": "1bfc57a2-d399-47a6-bfa2-a01beaf03758",
    "name": "Filter Test Shelter 2 1748819601061",
    "type": "shelter",
    "description": "Test shelter 2 for filtering",
    "logo": null,
    ...
    "status": "active",
    "createdBy": "tYFy4ecd0TY2fErw9jsp6e1XHvw1",
    "createdAt": "2025-06-01T23:13:21.525Z",
    "updatedAt": "2025-06-01T23:13:21.525Z"
  }
}
```
...
<details><summary>📡 Request #4: POST http://localhost:3000/api/organizations (492.4ms)</summary>
...
```json
{
  ...
  "data": {
    "name": "Filter Test Shelter 3 1748819601592",
    "type": "shelter",
    "description": "Test shelter 3 for filtering",
    "address": "102 Filter Street",
    "phone": "+1234567892",
    "email": "filter-shelter-2-1748819601592@example.com"
  }
}
```
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "408",
    "etag": "W/\"198-405Ic0E6SKE4uX29QFRu0tTFXvA\"",
    "date": "Sun, 01 Jun 2025 23:13:22 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    "id": "b6297bc0-ce5c-484f-af5a-f4376c271651",
    "name": "Filter Test Shelter 3 1748819601592",
    "type": "shelter",
    "description": "Test shelter 3 for filtering",
    "logo": null,
    ...
    "status": "active",
    "createdBy": "tYFy4ecd0TY2fErw9jsp6e1XHvw1",
    "createdAt": "2025-06-01T23:13:22.023Z",
    "updatedAt": "2025-06-01T23:13:22.023Z"
  }
}
```
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/organizations?type=shelter (851.0ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "etag": "W/\"b405-mZVobVQmGQhRScfa8uVk8u3tzYw\"",
    "date": "Sun, 01 Jun 2025 23:13:22 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
...
Expected substring: [32m"Invalid organization type filter"[39m
Received string:    [31m"Invalid query parameters"[39m  

#### 🌐 HTTP Requests & Responses

<details><summary>📡 Request #1: GET http://localhost:3000/api/organizations?type=invalid_type (438.8ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "date": "Sun, 01 Jun 2025 23:13:23 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/organizations (696.4ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-length": "46085",
    "etag": "W/\"b405-mZVobVQmGQhRScfa8uVk8u3tzYw\"",
    "date": "Sun, 01 Jun 2025 23:13:24 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": [
...
<details><summary>📡 Request #1: POST http://localhost:3000/api/organizations (444.9ms)</summary>
...
<details><summary>📡 Request #1: POST http://localhost:3000/api/organizations (424.2ms)</summary>
...
<details><summary>📡 Request #1: POST http://localhost:3000/api/organizations (427.1ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-length": "122",
    "etag": "W/\"7a-cv5Moexh9jmlV9a8h361//b+/xg\"",
    "date": "Sun, 01 Jun 2025 23:13:25 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #2: DELETE http://localhost:3000/api/organizations/d60cffc3-7816-4ca5-81b3-9dc8d446a4c6 (1047.1ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "date": "Sun, 01 Jun 2025 23:13:26 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
**⏱️ Duration:** 1047.1 ms  

</details>

<details><summary>📡 Request #3: DELETE http://localhost:3000/api/organizations/bdba4baa-a1af-4b75-a647-118b3311eff2 (997.1ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-length": "47",
    "etag": "W/\"2f-C4xREmSZpo7Mho+ixbrcQPJF0Zw\"",
    "date": "Sun, 01 Jun 2025 23:13:27 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #4: DELETE http://localhost:3000/api/organizations/6bb3ff06-82f4-4f96-b390-328efb5a4455 (1021.7ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-length": "47",
    "etag": "W/\"2f-C4xREmSZpo7Mho+ixbrcQPJF0Zw\"",
    "date": "Sun, 01 Jun 2025 23:13:28 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
**⏱️ Duration:** 1021.7 ms  

</details>

<details><summary>📡 Request #5: DELETE http://localhost:3000/api/organizations/1bfc57a2-d399-47a6-bfa2-a01beaf03758 (943.8ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-length": "47",
    "etag": "W/\"2f-C4xREmSZpo7Mho+ixbrcQPJF0Zw\"",
    "date": "Sun, 01 Jun 2025 23:13:29 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #6: DELETE http://localhost:3000/api/organizations/b6297bc0-ce5c-484f-af5a-f4376c271651 (925.6ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-length": "47",
    "etag": "W/\"2f-C4xREmSZpo7Mho+ixbrcQPJF0Zw\"",
    "date": "Sun, 01 Jun 2025 23:13:30 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #7: POST http://localhost:3000/api/auth/login (317.6ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "1600",
    "etag": "W/\"640-ulsqE0HPLCrlF4c2htSn785Qf0o\"",
    "date": "Sun, 01 Jun 2025 23:13:30 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    ...
    "tokens": {
      "idToken": "eyJhbGciOiJSUzI1NiIsImtpZCI6IjZlODk1YzQ3YTA0YzVmNmRlMzExMmFmZjE2ODFhMzUwNzdkMWNjZDQiLCJ0eXAiOiJKV1QifQ..mlyJD_WZv6x6gmwH3WrPXwBTUw68qEryNZA36LCD5OrkqBi2cDuo4x6-Ow0AFdK93P8NGZEscUjXQIvlEbBLrdkEfjJW7qKtU2vd1tdLmqKFVnulrdmYIvmhZwmlaY5tsHiC1YiVmSraz0zo0caX-YrIIBCEk76saSa_RrNT1SEQnuum9Ml-JBitkyAksq3V0kAne7LH8_wwD_akasSwSgRXP_hAK-1Bp3A-gPbz8LV94TFfsuLwP6POSGryWONDPFL7f7fjbcMtvSscP_ef3MVBnb7nVJ0lf3N-o8TLbB2E8zBACexl1vqSG04K11P6CqdlSGrA1NBaI_tCiCV4SQ",
      "refreshToken": "AMf-vBy4mljF_Ns0ZBmnYBHoJvyl6ECz9VegSr1bbJlo6gTRTKHVgTizb28sg17Sv-WEwvCngJhVVYGA9LExcEsUwgJgQ50IsVmTy8QukmX6kQBUADVBd1YG1p0alkyW6tDclW2Cqfnrl0e3IC3JbVEWo6BJ7Ilp8Uy-xavQQgY-aqSvhryusnGBBDiJudY_jTBAnNqfFIMJX7n2HL-vO-0gwsC2JlDeuL7sAwrD3xwGcEnU9IlCf8NIoHvOpXHWuN3HRpx5tZLr",
      "expiresIn": "3600"
    }
  }
}
...
<details><summary>📡 Request #8: DELETE http://localhost:3000/api/admin/users/dCj9etJNM4dQSI4qK44Zz6G1PnW2 (1432.1ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "date": "Sun, 01 Jun 2025 23:13:32 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
