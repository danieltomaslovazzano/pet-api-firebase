...
|-----------|--------|----------|-------------|
| ✅ Organization Types E2E Tests Get Organization Types Should get all available organization types | PASSED | 0.71s | Organization Types E2E Tests Get Organization Types Should get all available organization types |
| ✅ Organization Types E2E Tests Get Organization Types Regular user should also get organization types | PASSED | 0.44s | Organization Types E2E Tests Get Organization Types Regular user should also get organization types |
| ✅ Organization Types E2E Tests Get Organization Types Should fail without authentication | PASSED | 0.09s | Organization Types E2E Tests Get Organization Types Should fail without authentication |
| ✅ Organization Types E2E Tests Get Specific Organization Type Should get shelter type information | PASSED | 0.59s | Organization Types E2E Tests Get Specific Organization Type Should get shelter type information |
| ✅ Organization Types E2E Tests Get Specific Organization Type Should fail for invalid organization type | PASSED | 0.44s | Organization Types E2E Tests Get Specific Organization Type Should fail for invalid organization type |
| ✅ Organization Types E2E Tests Get Specific Organization Type Should fail without authentication | PASSED | 0.03s | Organization Types E2E Tests Get Specific Organization Type Should fail without authentication |
| ✅ Organization Types E2E Tests Create Organization with Type Should create shelter organization successfully | PASSED | 1.12s | Organization Types E2E Tests Create Organization with Type Should create shelter organization successfully |
| ✅ Organization Types E2E Tests Create Organization with Type Should create organization with default type when not specified | PASSED | 0.59s | Organization Types E2E Tests Create Organization with Type Should create organization with default type when not specified |
| ✅ Organization Types E2E Tests Create Organization with Type Should fail with invalid organization type | PASSED | 0.42s | Organization Types E2E Tests Create Organization with Type Should fail with invalid organization type |
| ✅ Organization Types E2E Tests Create Organization with Type Should validate required fields for shelter type | PASSED | 0.46s | Organization Types E2E Tests Create Organization with Type Should validate required fields for shelter type |
| ✅ Organization Types E2E Tests Create Organization with Type Should handle empty string type | PASSED | 0.44s | Organization Types E2E Tests Create Organization with Type Should handle empty string type |
| ✅ Organization Types E2E Tests Update Organization Type Should update organization type successfully | PASSED | 0.39s | Organization Types E2E Tests Update Organization Type Should update organization type successfully |
| ✅ Organization Types E2E Tests Update Organization Type Should fail when updating to invalid type | PASSED | 0.44s | Organization Types E2E Tests Update Organization Type Should fail when updating to invalid type |
| ✅ Organization Types E2E Tests Filter Organizations by Type Should filter organizations by shelter type | PASSED | 0.88s | Organization Types E2E Tests Filter Organizations by Type Should filter organizations by shelter type |
| ✅ Organization Types E2E Tests Filter Organizations by Type Should fail with invalid type filter | PASSED | 0.42s | Organization Types E2E Tests Filter Organizations by Type Should fail with invalid type filter |
| ✅ Organization Types E2E Tests Filter Organizations by Type Should return all organizations when no type filter is applied | PASSED | 0.83s | Organization Types E2E Tests Filter Organizations by Type Should return all organizations when no type filter is applied |
| ✅ Organization Types E2E Tests Organization Type Validation Edge Cases Should handle null type | PASSED | 0.53s | Organization Types E2E Tests Organization Type Validation Edge Cases Should handle null type |
| ✅ Organization Types E2E Tests Organization Type Validation Edge Cases Should handle case sensitivity | PASSED | 0.49s | Organization Types E2E Tests Organization Type Validation Edge Cases Should handle case sensitivity |
| ✅ Organization Types E2E Tests Language Support Should support different languages | PASSED | 0.46s | Organization Types E2E Tests Language Support Should support different languages |
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/organizations/types (707.2ms)</summary>

**📤 Request:**
```json
{
  "headers": {
    "Authorization": "Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6ImE0YTEwZGVjZTk4MzY2ZDZmNjNlMTY3Mjg2YWU5YjYxMWQyYmFhMjciLCJ0eXAiOiJKV1QifQ..LB3CFSd2uzBuEMdroEa7G-P5s4Aff6rLz00GKKBdrkfYfMOs68zUSapKHQIRMyk4tdu5CMWv1D2kVjMJSSSfw6Q54kDykfI_gZPAglfE26VXUrbFm3eh9sjQYXbQM1GPDfte1vj84svEI74hEXWCMJirXpFfZ5bhqMbzg5I-2WTtjQIClaEoOz4AQtDr-OAQzNcpJszDU6e11yLSpAkV3toy1x1MlvlRMyP99LHzvzHjd5nu-v7vStG6dCBlMe2fXYvsRO1quhbuX7Bf-xL_Jc-NXPGBMZs9rYlPPRa6dvYo_aSlwJBYNV1ahxT1chvgGwzjsh1co_GdIcC_s3b8aw",
    "Accept-Language": "en"
  }
}
```
...
```json
{
  ...
  "headers": {
    ...
    "date": "Fri, 13 Jun 2025 14:18:53 GMT",
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/organizations/types (439.0ms)</summary>

**📤 Request:**
```json
{
  "headers": {
    "Authorization": "Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6ImE0YTEwZGVjZTk4MzY2ZDZmNjNlMTY3Mjg2YWU5YjYxMWQyYmFhMjciLCJ0eXAiOiJKV1QifQ..gwwaOJYSJ_I84E7ibjqLX9TGNd41ATSralF0AbOmdoTppSfevPBRIG4a1hibxDakrC32SagqK2NkAWYpgfjd7Fke9PDBDy6ijXGIHbA-2NYktxbra7RjGznFVm-noBYTzlW3BV-rWmLW2792KIkFVOFOAfMF53ShzoWCt72j60I8U1NDTF2OS78Db7bWT5-hQUz3t7_a4RZSaTc4Zr2hOkThVuKaAb6YRSrPQaeQAeNT51KPBkFY8Xixbj3pyPcr9cZNcI8Y-QD1TE347cm7pYgIVaPgzJxEPWdoXlQNTbZTQg1CWoTvoJRQbZXOLFvCqbom3M8LG1UUY92Eo6Otzw",
    "Accept-Language": "en"
  }
}
```
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/organizations/types (85.0ms)</summary>
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/organizations/types/shelter (588.2ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "date": "Fri, 13 Jun 2025 14:18:54 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/organizations/types/invalid_type (438.7ms)</summary>
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/organizations/types/shelter (22.7ms)</summary>
...
<details><summary>📡 Request #1: POST http://localhost:3000/api/organizations (1115.9ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "542",
    "etag": "W/\"21e-I+3iBtB0ldwgPgdMdLsYBcax82o\"",
    "date": "Fri, 13 Jun 2025 14:18:55 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #1: POST http://localhost:3000/api/organizations (588.3ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "552",
    "etag": "W/\"228-S3ySLs22m7uiD8RDpfaQMlK9zFE\"",
    "date": "Fri, 13 Jun 2025 14:18:56 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #1: POST http://localhost:3000/api/organizations (460.6ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "date": "Fri, 13 Jun 2025 14:18:57 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #1: POST http://localhost:3000/api/organizations (435.3ms)</summary>
...
<details><summary>📡 Request #2: POST http://localhost:3000/api/organizations (436.5ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "559",
    "etag": "W/\"22f-Oew9F//YVk1zGO+Hf8iwBazxcOw\"",
    "date": "Fri, 13 Jun 2025 14:18:58 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #1: PUT http://localhost:3000/api/organizations/undefined (386.3ms)</summary>
...
<details><summary>📡 Request #1: PUT http://localhost:3000/api/organizations/undefined (438.5ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-length": "86",
    "etag": "W/\"56-c65qAc7poUVdeefNsXrlFxfQepU\"",
    "date": "Fri, 13 Jun 2025 14:18:59 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #2: POST http://localhost:3000/api/organizations (490.6ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "554",
    "etag": "W/\"22a-kKyyH1zcWK/j73XF3S/BTfKG8b8\"",
    "date": "Fri, 13 Jun 2025 14:18:59 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
...
<details><summary>📡 Request #3: POST http://localhost:3000/api/organizations (547.2ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "554",
    "etag": "W/\"22a-jg42aHcjD5BPsIKl5Azud/5aaYE\"",
    "date": "Fri, 13 Jun 2025 14:19:00 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #4: POST http://localhost:3000/api/organizations (450.0ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "554",
    "etag": "W/\"22a-zgow1P4dBkmwKa5AWZB2w17tVZo\"",
    "date": "Fri, 13 Jun 2025 14:19:00 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/organizations?type=shelter (879.9ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "etag": "W/\"14177-HdyMayfAQmY2Dt5J5UVFI06cXXw\"",
    "date": "Fri, 13 Jun 2025 14:19:01 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/organizations?type=invalid_type (416.5ms)</summary>
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/organizations (825.1ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-length": "82295",
    "etag": "W/\"14177-HdyMayfAQmY2Dt5J5UVFI06cXXw\"",
    "date": "Fri, 13 Jun 2025 14:19:02 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #1: POST http://localhost:3000/api/organizations (528.0ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "date": "Fri, 13 Jun 2025 14:19:03 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #1: POST http://localhost:3000/api/organizations (487.5ms)</summary>
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/organizations/types/shelter (459.5ms)</summary>
...
<details><summary>📡 Request #2: DELETE http://localhost:3000/api/organizations/undefined (449.2ms)</summary>
...
<details><summary>📡 Request #3: DELETE http://localhost:3000/api/organizations/undefined (408.7ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-length": "86",
    "etag": "W/\"56-c65qAc7poUVdeefNsXrlFxfQepU\"",
    "date": "Fri, 13 Jun 2025 14:19:05 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #4: DELETE http://localhost:3000/api/organizations/undefined (496.2ms)</summary>
...
<details><summary>📡 Request #5: DELETE http://localhost:3000/api/organizations/undefined (369.3ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-length": "86",
    "etag": "W/\"56-c65qAc7poUVdeefNsXrlFxfQepU\"",
    "date": "Fri, 13 Jun 2025 14:19:06 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #6: POST http://localhost:3000/api/auth/login (249.0ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "1706",
    "etag": "W/\"6aa-IZYzcVTlDBqydCOMe55Igs2UaH8\"",
    "date": "Fri, 13 Jun 2025 14:19:06 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    ...
    "data": {
      ...
      "tokens": {
        "idToken": "eyJhbGciOiJSUzI1NiIsImtpZCI6ImE0YTEwZGVjZTk4MzY2ZDZmNjNlMTY3Mjg2YWU5YjYxMWQyYmFhMjciLCJ0eXAiOiJKV1QifQ..knvX_r5Z7j5Wzavm_o3lBTBByHLqhjgJ4QJTtWy2VU-8-Zy8D1tCPg8xxn2iS67ekQczKllToGz0HbNJiZsGfRrYRIRcp770b3-_4rHMmUyYsTk6-VHpgoNAwtpNVn5Z98P6LARvNZTl1QP42oI1RME9REE3enOS6e7Golg1Cxr0BcOswjgsLZv6YscQLlIaJWxsUub01wcfL-QExvsNv9jA4XgLXDV12CSLKQ7jG59xzAlAghk23wjaCzSkUiyIVSeNN3eos8FYZqF4JuQb3WqDxcVjFvEwHh_kfEVG-YuUmFyg2pvA1VngLcqCQUuX14mMX4w2q7-LiHtEuQKVeQ",
        "refreshToken": "AMf-vBwMhHkD9voqyxXjmhZ09fgn2a-iNjaBvTBXgT6caFf_tKFok0iw6K-ZacRCQK8xjK4Oj5D26XXIGjBrQ1R6Ws2Ms2fIDe5XivswiguuVJ9SnIlNv8-JnvbpfOdX_9Kj8ebkqD6uVNF0yrVm3Fy4VmVBZhrVT8pLPhSVCfo-UmpQWvjoW9SP7Gq-jxPUfAe7t1GOX9e1pfDE5phgVhvYNM5tNKzhFYeIINVJ-GrNfo7DWSJiTVqi9tZCXx5UPxZtCuOhwlD3",
        "expiresIn": "3600"
      }
    },
...
<details><summary>📡 Request #7: DELETE http://localhost:3000/api/admin/users/sZkY4Sw8Fbc3hQWwgqfXdfbK6PZ2 (1487.6ms)</summary>

**📤 Request:**
```json
{
  "headers": {
    "Authorization": "Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6ImE0YTEwZGVjZTk4MzY2ZDZmNjNlMTY3Mjg2YWU5YjYxMWQyYmFhMjciLCJ0eXAiOiJKV1QifQ..knvX_r5Z7j5Wzavm_o3lBTBByHLqhjgJ4QJTtWy2VU-8-Zy8D1tCPg8xxn2iS67ekQczKllToGz0HbNJiZsGfRrYRIRcp770b3-_4rHMmUyYsTk6-VHpgoNAwtpNVn5Z98P6LARvNZTl1QP42oI1RME9REE3enOS6e7Golg1Cxr0BcOswjgsLZv6YscQLlIaJWxsUub01wcfL-QExvsNv9jA4XgLXDV12CSLKQ7jG59xzAlAghk23wjaCzSkUiyIVSeNN3eos8FYZqF4JuQb3WqDxcVjFvEwHh_kfEVG-YuUmFyg2pvA1VngLcqCQUuX14mMX4w2q7-LiHtEuQKVeQ"
  }
}
```
...
```json
{
  ...
  "headers": {
    ...
    "date": "Fri, 13 Jun 2025 14:19:07 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
