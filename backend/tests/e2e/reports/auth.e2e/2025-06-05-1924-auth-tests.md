...
|-----------|--------|----------|-------------|
| ✅ E2E: Auth should register a user | PASSED | 2.28s | E2E: Auth should register a user |
| ✅ E2E: Auth should login user | PASSED | 0.32s | E2E: Auth should login user |
| ✅ E2E: Auth should deny login with wrong credentials | PASSED | 0.26s | E2E: Auth should deny login with wrong credentials |
| ✅ E2E: Auth should access profile with token | PASSED | 0.02s | E2E: Auth should access profile with token |
...
| ✅ E2E: Auth should list users as admin | PASSED | 0.69s | E2E: Auth should list users as admin |
...
<details><summary>📡 Request #1: POST http://localhost:3000/api/auth/register (2275.5ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-length": "1526",
    "etag": "W/\"5f6-At+C8Zb6htl5i8otfk9vNlDfWjk\"",
    "date": "Thu, 05 Jun 2025 17:24:04 GMT",
  ...
  "data": {
    ...
    "data": {
      ...
      "tokens": {
        "idToken": "eyJhbGciOiJSUzI1NiIsImtpZCI6IjZlODk1YzQ3YTA0YzVmNmRlMzExMmFmZjE2ODFhMzUwNzdkMWNjZDQiLCJ0eXAiOiJKV1QifQ..E1sh47q_uzHowVmCaU6QhxaIQmRCsIqfIv831cbYcl-1onFhfRmtClzLDoj_WcqraddrKa0HqjZOHlN8iNI5BZpHAVll0YqHC4GDnrF2ab2EEWJOmFajIj2k3f2JGygJEjWGkV4KMbPBUgrZ7zi24xOwFhuz48iZY8_aytf5Jpo4TTJ7MGrIlwvpMgT84V23MX4zPm68-CjRV0Vb0zsV-xjMzMTk1sh7FXV5htMMZN0IXBB6Nvst5kZkr5JNKX72VT0RQxQOfutFZcw5i8amgQZPoeNKmGRmKFOttE1_OZFmbW8T-FO7ah9hpQhOi6kVVszRNx_laz_QUQPYta92Vw",
        "refreshToken": "AMf-vByxbz37vVQN32j8_DDprFuR58NCxGwsNKg-7JAf_m-cD1hYqrx9vQg1sDXmLu2jSXQykOxuQyCC418rf9APnSyKS8irgZGzVSu4YZsc84GPJzTQTTArNK0jMbBB9hG2eOOyjXezWT5WemxHhEbNeZV6Ubg9TziKADFapXYEXMO9bG0Yr2de4znLjyVqEXwMz2GpaujvqyoD3Nn0FKW27-47S2bdnJDgKHyqfcxUufu60vXv7hc",
        "expiresIn": "3600"
      }
    },
...
<details><summary>📡 Request #1: POST http://localhost:3000/api/auth/login (322.9ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "1505",
    "etag": "W/\"5e1-H9il17qVRL/fcSaNPeqQj/9qNgw\"",
    "date": "Thu, 05 Jun 2025 17:24:05 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    ...
    "data": {
      ...
      "tokens": {
        "idToken": "eyJhbGciOiJSUzI1NiIsImtpZCI6IjZlODk1YzQ3YTA0YzVmNmRlMzExMmFmZjE2ODFhMzUwNzdkMWNjZDQiLCJ0eXAiOiJKV1QifQ..g69fhAq1Zm5fJGAEeEqdLxMqHUOFuWO90Ldo877ynKQYDrKW_cnOiWivYjtf6JDJ_k-7YENlE5phGHsGPeSSKg2kIumHtCDPVQk_pACqeK8LmNkMCQdwsJ0vEFfBLFsxf2_70hQEClsu1QdV9ZMJn3WWrW2MyIKgo0rJPcrEWQ9_pSZHAtHBTQvRQt3HdbPwh20nClarMPbvkJIpE6jzH2aFoZicysqrWCu4xCLZOkC6556tOhFouYm6hsevVfN5fAlG4bdCzh_PLnkSWf741aenFPbNZgUdDO7vINzr9_UfnuPMPdo17lCQpCGuHePzi21Is-7HgIPxoPvOVJr2xw",
