...
curl -X POST http://localhost:3000/api/auth/register \
  ...
  -d '{"email":"e2euser_1748041642364@example.com","password":"test1234","name":"E2E User"}'
```
...
curl -X POST http://localhost:3000/api/auth/login \
  -H "Content-Type: application/json" \
  -d '{"email":"e2euser_1748041642364@example.com","password":"test1234"}'
```
...
curl -X POST http://localhost:3000/api/auth/login \
  -H "Content-Type: application/json" \
  -d '{"email":"e2euser_1748041642364@example.com","password":"wrongpassword"}'
```
...
curl -X GET http://localhost:3000/api/users/me \
  -H "Authorization: Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6IjY3ZDhjZWU0ZTYwYmYwMzYxNmM1ODg4NTJiMjA5MTZkNjRjMzRmYmEiLCJ0eXAiOiJKV1QifQ..mGGZAj105XmZZrOYntcxWY-bRXCiKibmkKhUYbJmBuVmjQvRHidMrjzECStKhdylII4nX0rQx0iMliAY7jcfNz3kfZPxNF5hNOaBDvF20dGkyueB868NArCaIy32eEuxMqAG76qZge4Jpsr5HcYrUc1HNd2ZlKrxSlNR7bS_l6QlpvGGdYkxOwas3Mf9cr2KeIpBlfaxnkvpelpU9kMoJLpbsLEn8UZ6JzfeHcJ8tdileLyNl3JYHjawygYE4AWsW8ZcCuViMXQN1PyyoHqjgh1USNIHxo2G_DbyBC0e7n8Ftiyq7BMIAZmXj5aMHMy6G-9OLXucL7hnsZ2joMSspQ"
```
...
curl -X GET http://localhost:3000/api/admin/users \
  -H "Authorization: Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6IjY3ZDhjZWU0ZTYwYmYwMzYxNmM1ODg4NTJiMjA5MTZkNjRjMzRmYmEiLCJ0eXAiOiJKV1QifQ..bQMcyzvIpBLg1FdHLdDVMruIVXLsiqmj0fZcL4KW6jXwDjdcSdMmOjmLwMRcJnMyvkJH3L6JzK4LwvD6_2f1X0EOKEWVBWe9e2u5B7tQ3RrpHzbU5azZQmOYVImmR470qxRhlTNqzT4OqcBgxc9BLYRbEQORzXTiOj25YNQYhReCyJsCF1eQLzo4pg8bp-cx2WyFe0VU6jRVwjXAFbS8Nasbr2PC1PTgz4bg95sKtbxMDmurgq2Soz6R696yCH7HhRkYubNTgezjPlDOLZ5e6zPuzhnMbFNYKv46x8l_GMW7Z3hPcBwRzDNfcP5UqZCokZGmTVkm4eWx0ZNHOsm6Rg"
```
...
```json
{
  ...
  "tokens": {
    "idToken": "eyJhbGciOiJSUzI1NiIsImtpZCI6IjY3ZDhjZWU0ZTYwYmYwMzYxNmM1ODg4NTJiMjA5MTZkNjRjMzRmYmEiLCJ0eXAiOiJKV1QifQ..aZC9qWQpxbLWsUhWZ3SGkVprWr-sYvZ1Y5kPZwZNiAvJ7-z64KAZgMJh-BXlC054QZK8tBlyyAmhn0TZGEDffdHWoJgB216mxBMme33QUJY9AOQOmF1wmsflA9OLhjb0IcLFx1hZjRPkTut46UTq1TvZd1Vpp75VSogs-TfSYs9MQyLU__VuArMeNcRXvOFI3kgI8t5Kmx8cGn92OwlgtnOMJaRdRRMw7oJQ--lPt5oVxXfcNsgdPTQlitPTQfq5jvK-xhC_wZBjoj6RM0tzsm6JVh4PSzhaHcAt6-8KkU64et6UgWBSxojiGZHMpjDx2sNGFUkQPC3SP24HjcRVWQ",
    "refreshToken": "AMf-vByrmeLwrdn6P0E0m4MIBL0GE_In2Ye2vDDaOVdEXr6v_0dP3Z81FZ4o5Th1ALZnnO3egxbrDo4NPckk7NYUM6xsHGuor1S4nWvXX2V9SqAt2J0ztbmihC0sPxipFfYgwsar4E2kBMCNLADK5az1scIG3mWTd4Udr9qScLJiH63NzxWK8hnrnrINhlWSOmspGn_EnmbRV7vKIA6Lo2rzouqPvHPfu_2FE4Y2ne0jqKaGclclebo",
    "expiresIn": "3600"
  }
}
```
...
```json
{
  ...
  "tokens": {
    "idToken": "eyJhbGciOiJSUzI1NiIsImtpZCI6IjY3ZDhjZWU0ZTYwYmYwMzYxNmM1ODg4NTJiMjA5MTZkNjRjMzRmYmEiLCJ0eXAiOiJKV1QifQ..mGGZAj105XmZZrOYntcxWY-bRXCiKibmkKhUYbJmBuVmjQvRHidMrjzECStKhdylII4nX0rQx0iMliAY7jcfNz3kfZPxNF5hNOaBDvF20dGkyueB868NArCaIy32eEuxMqAG76qZge4Jpsr5HcYrUc1HNd2ZlKrxSlNR7bS_l6QlpvGGdYkxOwas3Mf9cr2KeIpBlfaxnkvpelpU9kMoJLpbsLEn8UZ6JzfeHcJ8tdileLyNl3JYHjawygYE4AWsW8ZcCuViMXQN1PyyoHqjgh1USNIHxo2G_DbyBC0e7n8Ftiyq7BMIAZmXj5aMHMy6G-9OLXucL7hnsZ2joMSspQ",
    "refreshToken": "AMf-vBywouZe_41f8AibxjY2ED-eWeBP4wXEOAW5QumxPOiWS_FmjhRGeJH-l809PngmProGbueEurPfRba5coz9FxyuO7VVPh90mzp2ElnrtZTsuzmAaLyZXwMXJAOOvaJRJsf-7yjALIUStXQ7j8CYcHYb_QdFnhrq8j5W4hjDZUFO7mnCMNzgtZYc6JSZ5A-bYDMd-EAdjhRjvoCLu9lPcevlP94NVTnWTFjemrMMfIlmm2FYlDs",
    "expiresIn": "3600"
  }
}
```
...
```json
{
  ...
  "tokens": {
    "idToken": "eyJhbGciOiJSUzI1NiIsImtpZCI6IjY3ZDhjZWU0ZTYwYmYwMzYxNmM1ODg4NTJiMjA5MTZkNjRjMzRmYmEiLCJ0eXAiOiJKV1QifQ..bQMcyzvIpBLg1FdHLdDVMruIVXLsiqmj0fZcL4KW6jXwDjdcSdMmOjmLwMRcJnMyvkJH3L6JzK4LwvD6_2f1X0EOKEWVBWe9e2u5B7tQ3RrpHzbU5azZQmOYVImmR470qxRhlTNqzT4OqcBgxc9BLYRbEQORzXTiOj25YNQYhReCyJsCF1eQLzo4pg8bp-cx2WyFe0VU6jRVwjXAFbS8Nasbr2PC1PTgz4bg95sKtbxMDmurgq2Soz6R696yCH7HhRkYubNTgezjPlDOLZ5e6zPuzhnMbFNYKv46x8l_GMW7Z3hPcBwRzDNfcP5UqZCokZGmTVkm4eWx0ZNHOsm6Rg",
    "refreshToken": "AMf-vBw_IfIhjWXQ8sg837FZiWxGHhKI3ePx4oIMzxZLabqW6xjzR_dbfIcQKLO6HjBonY-MXWU0l40svZfRpw1B3T_TJbWVh3tPoMy-eP9_qYF4YN8MPGAyIUWa5w_ygCT5PBukTtRzvdCoHmtkukaSKVkc_6IwY5ykxUcpQDqzrGMLCNrri49NAJidO5YlX6AW-zadSHtHyeTi2jF8EVY41HePnS9fTWSikDSBPBamI6DDYdRtb5Y",
    "expiresIn": "3600"
  }
}
```
...
**Observaciones:**
- Email de usuario: e2euser_1748041642364@example.com
