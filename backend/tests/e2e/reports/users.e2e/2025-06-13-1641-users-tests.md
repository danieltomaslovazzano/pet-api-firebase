...
|-----------|--------|----------|-------------|
| ✅ E2E: Users should create a user | PASSED | 2.82s | E2E: Users should create a user |
| ✅ E2E: Users should get user by ID | PASSED | 0.79s | E2E: Users should get user by ID |
...
| ✅ E2E: Users should change user role | PASSED | 0.56s | E2E: Users should change user role |
| ✅ E2E: Users should delete user | PASSED | 0.56s | E2E: Users should delete user |
...
<details><summary>📡 Request #1: POST http://localhost:3000/api/users (2813.9ms)</summary>

**📤 Request:**
```json
{
  "headers": {
    "Authorization": "Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6ImE0YTEwZGVjZTk4MzY2ZDZmNjNlMTY3Mjg2YWU5YjYxMWQyYmFhMjciLCJ0eXAiOiJKV1QifQ..HvuCYKq2rKzgOFLrcLmJwIo4_7bsTTR7OJRmb_8BBX_7-d5SVKf9IZNN2NrJsrZHtrEeC6RgEsR-81FJhkJ6iGgD_p0gIa9Is6Yex8lyhQRd0NTxf8LyOZS5O_wn8B0x15rfRJbmXV0bkA-3qMQcjjVOdVEWpjij3yBSPJG1eRUJyJk3wOe5CJ0HTwgBIPS05l-xS3kTMBI4G_QA7LhW-o0bNmdjCyFGY195avlYpf_tqdPefmpkhWO72jjgdJk4QCutcjgQg1Tq3S38V1x5KFBv8GgfrHsBbPXnRVcY1o3UDfKddJqfnWei2WTuFt6ff18ytEfmeP3DtJ0vhQsnYg"
  },
  "data": {
...
```json
{
  ...
  "headers": {
    ...
    "content-length": "332",
    "etag": "W/\"14c-2sqzjB95AxRpHSqDOfDvV6lwTrs\"",
    "date": "Fri, 13 Jun 2025 14:41:34 GMT",
  ...
  "data": {
    ...
    "data": {
      ...
      "status": "active",
      "blockedUsers": [],
      "createdAt": "2025-06-13T14:41:33.924Z",
      "updatedAt": "2025-06-13T14:41:33.924Z"
    },
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/users/undefined (776.3ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "145",
    "etag": "W/\"91-sl6sINKoCJoD9CgIrVccsQ0N2oQ\"",
    "date": "Fri, 13 Jun 2025 14:41:34 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/users (600.4ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "etag": "W/\"b26b-ITRBNhdI2bikGdBkV2eIxxRvlGc\"",
    "date": "Fri, 13 Jun 2025 14:41:35 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #1: PUT http://localhost:3000/api/users/undefined (561.8ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "141",
    "etag": "W/\"8d-DofF064vixiuaRYGGqYCndMjGKg\"",
    "date": "Fri, 13 Jun 2025 14:41:36 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    "success": false,
    "error": "common.error_updating",
    "details": {
      "details": "User not found"
    },
    "messageKey": "common.error_updating",
    "language": "en"
  }
}
```
...
<details><summary>📡 Request #1: PUT http://localhost:3000/api/users/undefined (553.4ms)</summary>
...
<details><summary>📡 Request #1: DELETE http://localhost:3000/api/users/undefined (555.1ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "141",
    "etag": "W/\"8d-XFrbstFiqHeN3/qYQDjdqzYrzc8\"",
    "date": "Fri, 13 Jun 2025 14:41:37 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    "success": false,
    "error": "common.error_deleting",
    "details": {
      "details": "User not found"
    },
    "messageKey": "common.error_deleting",
    "language": "en"
  }
}
```
