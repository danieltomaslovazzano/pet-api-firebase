...
|-----------|--------|----------|-------------|
| ✅ E2E: Users should create a user | PASSED | 1.74s | E2E: Users should create a user |
| ✅ E2E: Users should get user by ID | PASSED | 0.63s | E2E: Users should get user by ID |
| ✅ E2E: Users should list users | PASSED | 0.49s | E2E: Users should list users |
| ✅ E2E: Users should update user | PASSED | 0.64s | E2E: Users should update user |
| ✅ E2E: Users should change user role | PASSED | 0.61s | E2E: Users should change user role |
| ✅ E2E: Users should delete user | PASSED | 1.05s | E2E: Users should delete user |
...
<details><summary>📡 Request #1: POST http://localhost:3000/api/users (1731.4ms)</summary>

**📤 Request:**
```json
{
  "headers": {
    "Authorization": "Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6ImZlNjVjY2I4ZWFkMGJhZWY1ZmQzNjE5NWQ2NTI4YTA1NGZiYjc2ZjMiLCJ0eXAiOiJKV1QifQ..POlgnFGIlTQkyAVIQ1A8Ce2GZmQqnZCnxE6IiZdjOzKMJ4wStLr-wRoTepq6SET6jh9610kUn4AK9jQU3bhYMETLhttm351PHTkqnoD-e6i73eJLTO1TteCvKk46a656OZmrp8EWtp7rrG5sLd1P-j99GpX9PBaVTv5RISKcXByPhhka_jmH9NvFG7TnLfIG1gR3yZUGLNdK2BHNmPnnQQeh4O1StyJqgT9UVxifcH1i_GLhHOv_Lovtf0mQ7zWfJdKBo4tZ4ErHT2MZaCHByz901c_2Y0gDBTMWkC9YXHRtx4_pYVp97xeTzSreAR56hnWvOvOtsFrzcbqp6sAyCw"
  },
  "data": {
    "email": "test_1748380036662@example.com",
    "password": "test1234",
    "name": "Test User",
    "role": "user"
  }
...
```json
{
  ...
  "headers": {
    ...
    "content-length": "225",
    "etag": "W/\"e1-/kY58D1WibvM5XkyZjnzjrhCeBg\"",
    "date": "Tue, 27 May 2025 21:07:18 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    "id": "ni6uUYWCVpTY3ypaghnpYejxYCs2",
    "email": "test_1748380036662@example.com",
    "name": "Test User",
    "role": "user",
    "status": "active",
    "blockedUsers": [],
    "createdAt": "2025-05-27T21:07:18.276Z",
    "updatedAt": "2025-05-27T21:07:18.276Z"
  }
}
```

**⏱️ Duration:** 1731.4 ms  
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/users/ni6uUYWCVpTY3ypaghnpYejxYCs2 (623.4ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "321",
    "etag": "W/\"141-QNH7oDuTQNU7IKXudG7LM8onIgs\"",
    "date": "Tue, 27 May 2025 21:07:19 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    ...
    "address": null,
    "blockedUsers": [],
    "createdAt": "2025-05-27T21:07:18.331Z",
    "updatedAt": "2025-05-27T21:07:18.331Z",
    "isSuperAdmin": false,
    "pets": [],
    "memberships": []
  }
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/users (483.9ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "etag": "W/\"60c1-OM4ps8cetCnAseMUiPofbB9mB1k\"",
    "date": "Tue, 27 May 2025 21:07:19 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
...
<details><summary>📡 Request #1: PUT http://localhost:3000/api/users/ni6uUYWCVpTY3ypaghnpYejxYCs2 (637.4ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "311",
    "etag": "W/\"137-bcVh8jmBbrWFXf+uCx+AGfCBqUw\"",
    "date": "Tue, 27 May 2025 21:07:20 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    ...
    "blockedUsers": [],
    "createdAt": "2025-05-27T21:07:18.331Z",
    "updatedAt": "2025-05-27T21:07:20.035Z",
    "isSuperAdmin": false
  }
}
```
...
<details><summary>📡 Request #1: PUT http://localhost:3000/api/users/ni6uUYWCVpTY3ypaghnpYejxYCs2 (612.6ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "316",
    "etag": "W/\"13c-qKMa3PW8H8ixDy0sJjohP8GWmeQ\"",
    "date": "Tue, 27 May 2025 21:07:20 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    ...
    "blockedUsers": [],
    "createdAt": "2025-05-27T21:07:18.331Z",
    "updatedAt": "2025-05-27T21:07:20.649Z",
    "isSuperAdmin": false
  }
}
```
...
<details><summary>📡 Request #1: DELETE http://localhost:3000/api/users/ni6uUYWCVpTY3ypaghnpYejxYCs2 (1049.4ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "date": "Tue, 27 May 2025 21:07:21 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
