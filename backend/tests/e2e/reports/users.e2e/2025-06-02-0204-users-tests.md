...
|-----------|--------|----------|-------------|
| ✅ E2E: Users should create a user | PASSED | 1.38s | E2E: Users should create a user |
| ✅ E2E: Users should get user by ID | PASSED | 0.67s | E2E: Users should get user by ID |
| ✅ E2E: Users should list users | PASSED | 0.61s | E2E: Users should list users |
| ✅ E2E: Users should update user | PASSED | 0.66s | E2E: Users should update user |
| ✅ E2E: Users should change user role | PASSED | 0.55s | E2E: Users should change user role |
| ✅ E2E: Users should delete user | PASSED | 0.84s | E2E: Users should delete user |
...
<details><summary>📡 Request #1: POST http://localhost:3000/api/users (1374.5ms)</summary>

**📤 Request:**
```json
{
  "headers": {
    "Authorization": "Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6IjZlODk1YzQ3YTA0YzVmNmRlMzExMmFmZjE2ODFhMzUwNzdkMWNjZDQiLCJ0eXAiOiJKV1QifQ..eDHwqswkow-5ersL53soJJEYbBoh3Cn6lowArX7tqhqpN4-BiVbUVyT5ljS57GOJmeeyEo4c0uLJY2hR6ez4pvFB3iDWKUwv0dshd-2wyMh-QVTEZtLhsMamdVzjl1yNgzFS7107CAWROdUTW9Z9dgMXVwiJDofLtxd3LXdwry8TDLp6qC99OMOcNTJyd56jpFFTLlHvzX3hw0QDT7Yd1IlKtUxk9Zf5UmP-dhxRaY2pX8QfvOCFR-CAAd98gepmdehkFENlKI17PeFzYiij1ORNwQH82Ba9-LyuX8frWMLkCd-iiyeRfhhIUi4K5el4BldGqXbVn1b6fz-76JwiHA"
  },
  "data": {
    "email": "test_1748822673291@example.com",
    "password": "test1234",
    "name": "Test User",
    "role": "user"
  }
...
```json
{
  ...
  "headers": {
    ...
    "content-length": "225",
    "etag": "W/\"e1-VSnPyHNFVycCQcSBJAGHRJDPE3U\"",
    "date": "Mon, 02 Jun 2025 00:04:34 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    "id": "5C3SCm3ByJMqEKbQxKAAGNr9Zbk2",
    "email": "test_1748822673291@example.com",
    "name": "Test User",
    "role": "user",
    "status": "active",
    "blockedUsers": [],
    "createdAt": "2025-06-02T00:04:34.541Z",
    "updatedAt": "2025-06-02T00:04:34.541Z"
  }
}
```

**⏱️ Duration:** 1374.5 ms  
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/users/5C3SCm3ByJMqEKbQxKAAGNr9Zbk2 (670.8ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "321",
    "etag": "W/\"141-zw4NPz5Z0pR7Eyu8gm1VKzf/l9o\"",
    "date": "Mon, 02 Jun 2025 00:04:35 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    ...
    "address": null,
    "blockedUsers": [],
    "createdAt": "2025-06-02T00:04:34.600Z",
    "updatedAt": "2025-06-02T00:04:34.600Z",
    "isSuperAdmin": false,
    "pets": [],
    "memberships": []
  }
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/users (610.6ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "etag": "W/\"7a4f-yYPSJmyINkPruM0LmgjeTUhIsNU\"",
    "date": "Mon, 02 Jun 2025 00:04:35 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
...
<details><summary>📡 Request #1: PUT http://localhost:3000/api/users/5C3SCm3ByJMqEKbQxKAAGNr9Zbk2 (661.2ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "311",
    "etag": "W/\"137-pv9DQsiuffvPpt/6P+9oeqOXFS0\"",
    "date": "Mon, 02 Jun 2025 00:04:36 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    ...
    "blockedUsers": [],
    "createdAt": "2025-06-02T00:04:34.600Z",
    "updatedAt": "2025-06-02T00:04:36.495Z",
    "isSuperAdmin": false
  }
}
```
...
<details><summary>📡 Request #1: PUT http://localhost:3000/api/users/5C3SCm3ByJMqEKbQxKAAGNr9Zbk2 (551.7ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "316",
    "etag": "W/\"13c-YQdw59+geS0JQMoVl5fGJXYI0O0\"",
    "date": "Mon, 02 Jun 2025 00:04:37 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    ...
    "blockedUsers": [],
    "createdAt": "2025-06-02T00:04:34.600Z",
    "updatedAt": "2025-06-02T00:04:37.049Z",
    "isSuperAdmin": false
  }
}
```
...
<details><summary>📡 Request #1: DELETE http://localhost:3000/api/users/5C3SCm3ByJMqEKbQxKAAGNr9Zbk2 (838.1ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "date": "Mon, 02 Jun 2025 00:04:38 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
