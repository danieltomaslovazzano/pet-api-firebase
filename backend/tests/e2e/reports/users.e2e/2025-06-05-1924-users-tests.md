...
|-----------|--------|----------|-------------|
| ✅ E2E: Users should create a user | PASSED | 1.58s | E2E: Users should create a user |
| ✅ E2E: Users should get user by ID | PASSED | 0.73s | E2E: Users should get user by ID |
| ✅ E2E: Users should list users | PASSED | 0.53s | E2E: Users should list users |
| ✅ E2E: Users should update user | PASSED | 0.67s | E2E: Users should update user |
| ✅ E2E: Users should change user role | PASSED | 0.87s | E2E: Users should change user role |
| ✅ E2E: Users should delete user | PASSED | 1.56s | E2E: Users should delete user |
...
<details><summary>📡 Request #1: POST http://localhost:3000/api/users (1578.3ms)</summary>

**📤 Request:**
```json
{
  "headers": {
    "Authorization": "Bearer eyJhbGciOiJSUzI1NiIsImtpZCI6IjZlODk1YzQ3YTA0YzVmNmRlMzExMmFmZjE2ODFhMzUwNzdkMWNjZDQiLCJ0eXAiOiJKV1QifQ..BTMmXPjXeO92V0pYvYl9BC3t4JdXjPCF5_fL4lfDs_D7R3L3ETfUXcYzHE5jnTwRwx1axf1HCA-Y7RT4cvRmHW0pHAJgGYtDvQCp5MGwKuVJBtSi1MACPSrNPeNlXYcJVVjDCPhYCx7z1mmQ-a9poc_ZkjrR0zmEQcLd46RaOY9js9OasiVkbd-UqMi0S-I1TK3BUNqkq-BKNwCkEHd2Gt6FJ3WJOIDPS9c8oWq6YgG3oKhmOQuwCOiuIo_T7kuzLzxNFpqlOH5ROZ4fNCaohvw-vFlJjLJnfrRtuQqSPD-H6lx7SekZLQLs6OfpfnsIk4kSEvPLxGQPomZWCNBeKg"
  },
  "data": {
    "email": "test_1749144251491@example.com",
    "password": "test1234",
    "name": "Test User",
    "role": "user"
  }
...
```json
{
  ...
  "headers": {
    ...
    "content-length": "332",
    "etag": "W/\"14c-U3avH6bUQpn852EvcWdZsOg1PZM\"",
    "date": "Thu, 05 Jun 2025 17:24:13 GMT",
  ...
  "data": {
    ...
    "data": {
      "id": "D2vPtkKi2ReU7WiPSqpiDfgwGrW2",
      "email": "test_1749144251491@example.com",
      "name": "Test User",
      "role": "user",
      "status": "active",
      "blockedUsers": [],
      "createdAt": "2025-06-05T17:24:12.960Z",
      "updatedAt": "2025-06-05T17:24:12.960Z"
    },
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/users/D2vPtkKi2ReU7WiPSqpiDfgwGrW2 (722.6ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "386",
    "etag": "W/\"182-VfDAGT418o+ESAEalypocKYDuXk\"",
    "date": "Thu, 05 Jun 2025 17:24:13 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    ...
    "data": {
      ...
      "createdAt": "2025-06-05T17:24:13.011Z",
      "updatedAt": "2025-06-05T17:24:13.011Z",
      "isSuperAdmin": false,
      "pets": [],
      "memberships": []
    },
...
<details><summary>📡 Request #1: GET http://localhost:3000/api/users (531.6ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "etag": "W/\"9cb3-G02T19Z/u/HUZ77sVjPT8gG2E/k\"",
    "date": "Thu, 05 Jun 2025 17:24:14 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
...
<details><summary>📡 Request #1: PUT http://localhost:3000/api/users/D2vPtkKi2ReU7WiPSqpiDfgwGrW2 (663.3ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "443",
    "etag": "W/\"1bb-JMnEBDnfCJFH8HiUd7goRu+Hqu4\"",
    "date": "Thu, 05 Jun 2025 17:24:14 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    ...
    "data": {
      ...
      "preferredLanguage": "en",
      "createdAt": "2025-06-05T17:24:13.011Z",
      "updatedAt": "2025-06-05T17:24:14.787Z",
      "isSuperAdmin": false
    },
...
<details><summary>📡 Request #1: PUT http://localhost:3000/api/users/D2vPtkKi2ReU7WiPSqpiDfgwGrW2 (865.8ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "content-type": "application/json; charset=utf-8",
    "content-length": "448",
    "etag": "W/\"1c0-ftJ+QDAU9SVM8W1YXXe2kcQ1et4\"",
    "date": "Thu, 05 Jun 2025 17:24:15 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
    ...
    "data": {
      ...
      "preferredLanguage": "en",
      "createdAt": "2025-06-05T17:24:13.011Z",
      "updatedAt": "2025-06-05T17:24:15.772Z",
      "isSuperAdmin": false
    },
    "messageKey": "users.updated",
    "language": "en"
...
<details><summary>📡 Request #1: DELETE http://localhost:3000/api/users/D2vPtkKi2ReU7WiPSqpiDfgwGrW2 (1562.4ms)</summary>
...
```json
{
  ...
  "headers": {
    ...
    "date": "Thu, 05 Jun 2025 17:24:17 GMT",
    "connection": "keep-alive",
    "keep-alive": "timeout=5"
  },
  "data": {
